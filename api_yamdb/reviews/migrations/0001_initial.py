# Generated by Django 5.2.8 on 2025-12-06 12:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('user', 'Пользователь'), ('admin', 'Администратор'), ('moderator', 'Модератор'), ('superuser', 'Суперюзер')], default='user', max_length=20, verbose_name='роль')),
